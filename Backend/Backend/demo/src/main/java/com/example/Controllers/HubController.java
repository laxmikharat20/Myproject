...
public class HubController {
    ...
    public List<HubMaster> getHubsByCityId(@PathVariable("cityId") Long cityId) {
        return hubService.getHubsByCityId(cityId);
    }

    @GetMapping("/airportCode/{airportCode}")
    public List<HubMaster> getHubsByAirportCode(@PathVariable("airportCode") String airportCode) {
